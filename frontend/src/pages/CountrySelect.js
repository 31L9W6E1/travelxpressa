...
const CountrySelect = () => {
    ...
    return (_jsx("main", { className: "min-h-screen bg-background text-foreground pt-24 pb-12 theme-transition", children: _jsxs("div", { className: "max-w-4xl mx-auto px-4", children: [_jsxs("div", { className: "text-center mb-12", children: [_jsx("div", { className: "inline-flex items-center justify-center w-16 h-16 bg-secondary rounded-full mb-6", children: _jsx(Globe, { className: "w-8 h-8 text-foreground" }) }), _jsx("h1", { className: "text-4xl font-bold mb-4", children: "Select Your Destination" }), _jsx("p", { className: "text-xl text-muted-foreground max-w-2xl mx-auto", children: "Choose the country you're applying to visit. We'll customize your application form based on that country's specific visa requirements." })] }), _jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-4 mb-12", children: countryList.map((country) => {
                ...
                `, children: "Click to select" })] }, country.code));
            ...
            `, children: selectedCountry ? (_jsxs(_Fragment, { children: ["Continue to Application", _jsx(ArrowRight, { className: "w-5 h-5" })] })) : ('Select a country to continue') }), selectedCountry && (_jsxs("p", { className: "text-sm text-muted-foreground", children: ["You selected: ", _jsxs("span", { className: "font-medium text-foreground", children: [countryList.find(c => c.code === selectedCountry)?.flag, ' ', countryList.find(c => c.code === selectedCountry)?.name] })] }))] }), _jsx("div", { className: "mt-16 bg-secondary rounded-2xl p-8 border border-border", children: _jsxs("div", { className: "flex items-start gap-4", children: [_jsx("div", { className: "w-12 h-12 bg-background rounded-lg flex items-center justify-center flex-shrink-0", children: _jsx(Plane, { className: "w-6 h-6 text-foreground" }) }), _jsxs("div", { children: [_jsx("h3", { className: "font-semibold text-lg mb-2", children: "Why does country selection matter?" }), _jsx("p", { className: "text-muted-foreground", children: "Each country has different visa requirements, document checklists, and application forms. By selecting your destination country upfront, we can:" }), _jsxs("ul", { className: "mt-4 space-y-2 text-muted-foreground", children: [_jsxs("li", { className: "flex items-center gap-2", children: [_jsx(Check, { className: "w-4 h-4 text-primary" }), "Show you the exact documents you'll need"] }), _jsxs("li", { className: "flex items-center gap-2", children: [_jsx(Check, { className: "w-4 h-4 text-primary" }), "Guide you through country-specific form sections"] }), _jsxs("li", { className: "flex items-center gap-2", children: [_jsx(Check, { className: "w-4 h-4 text-primary" }), "Provide accurate processing time estimates"] }), _jsxs("li", { className: "flex items-center gap-2", children: [_jsx(Check, { className: "w-4 h-4 text-primary" }), "Calculate the correct visa fees"] })] })] })] }) })] }) }));
};
